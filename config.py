...
# Database
# Railway: Gunakan folder project/app langsung (Railway persist working dir)
import os as _os
_BASE_DIR = _os.path.dirname(_os.path.abspath(__file__))
DATABASE_PATH = _os.getenv("DATABASE_PATH", _os.path.join(_BASE_DIR, "trading_journal.db"))
